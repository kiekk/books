INSERT INTO USERS (USERNAME, PASSWORD, ENABLED) VALUES ('marten@ya2do.io', '{noop}user', 1);
INSERT INTO USERS (USERNAME, PASSWORD, ENABLED) VALUES ('admin@ya2do.io', '{noop}secret', 1);
