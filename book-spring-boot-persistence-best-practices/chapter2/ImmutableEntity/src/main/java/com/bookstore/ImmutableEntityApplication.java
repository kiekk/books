...
public class ImmutableEntityApplication {

    private final BookstoreService bookstoreService;

    public ImmutableEntityApplication(BookstoreService bookstoreService) {
        this.bookstoreService = bookstoreService;
    }

    public static void main(String[] args) {
        SpringApplication.run(ImmutableEntityApplication.class, args);
    }
