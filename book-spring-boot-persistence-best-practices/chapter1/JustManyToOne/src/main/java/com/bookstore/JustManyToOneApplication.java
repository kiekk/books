...
public class JustManyToOneApplication {

	private final BookstoreService bookstoreService;

    public JustManyToOneApplication(BookstoreService bookstoreService) {
        this.bookstoreService = bookstoreService;
    }

    public static void main(String[] args) {
		SpringApplication.run(JustManyToOneApplication.class, args);
	}
