...
export default {
  ...
  methods: {
    ...
    fetchContacts: function(){
      ...
      .catch((error) => {
        console.log(`fetchContacts failed : ${error}`)
    ...
    addContact: function(contact){
      ...
      .catch((error) => {
        console.log(`addContact failed : ${error}`)
      })
    },
    updateContact: function(contact){
      ...
      .catch((error) => {
        console.log(`updateContact failed : ${error}`)
      })
    },
    fetchContactOne: function(no){
      ...
      .catch((error) => {
        console.log(`fetchContactOne failed : ${error}`)
      })
    },
    ...
    updatePhoto: function(no, file){
      ...
      .catch((error) => {
        console.log(`updatePhoto failed : ${error}`)
      })
    },
  }
}
