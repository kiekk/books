...
insert into book (isbn, title, genre, id) values ('001-JN', 'A History of Ancient Prague', 'History', 1);
insert into book (isbn, title, genre, id) values ('002-JN', 'A Peoples History', 'History', 2);
insert into book (isbn, title, genre, id) values ('001-MJ', 'The Beatles Anthology', 'Anthology', 3);
insert into book (isbn, title, genre, id) values ('001-OG', 'Carrie', 'Horror', 4);