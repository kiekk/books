...
insert into book (isbn, title, price, author_id, id) values ('001-JN', 'A History of Ancient Prague', 36, 4, 1);
insert into book (isbn, title, price, author_id, id) values ('002-JN', 'A Peoples History', 41, 4, 2);
insert into book (isbn, title, price, author_id, id) values ('001-MJ', 'The Beatles Anthology', 11, 1, 3);
insert into book (isbn, title, price, author_id, id) values ('001-OG', 'Carrie', 23, 2, 4);