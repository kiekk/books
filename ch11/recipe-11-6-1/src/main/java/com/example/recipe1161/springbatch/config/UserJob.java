package com.example.recipe1161.springbatch.config;

import com.example.recipe1161.springbatch.UserRegistration;
...
public class UserJob {
    ...
    public Step step1() {
        return steps.get("User Registration CSV To DB Step")
                ...
                .faultTolerant() // 오류 허용 스텝
                .retryLimit(3) // 재시도 제한 횟수
                .retry(DeadlockLoserDataAccessException.class) // 재시도
